...
object Dependencies {
  ...
  val zioProcess  = "dev.zio"        %% "zio-process"  % "0.3.0"
  val zioJson     = "dev.zio"        %% "zio-json"     % "0.0.0+28-e548a5ac-SNAPSHOT"
  val uzhttp      = "org.polynote"   %% "uzhttp"       % "0.2.6"

  val sshj        = "com.hierynomus"  % "sshj"         % "0.30.0"
  val commonsNet  = "commons-net"     % "commons-net"  % "3.7.2"
